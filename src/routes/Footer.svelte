<footer>
	<div class="inner">
		<span class="brand">TILTED<em>CRAFT</em></span>
		<p class="copy">Minecraft Vanilla++ · Fabric 1.20.1</p>
		<a href="https://discord.gg/SGYGyHRm" target="_blank" rel="noopener noreferrer" class="discord-link">
